        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function (data, type, full, meta) {
                    ...
                    return '<div id="botones-'+data.usuario+'"><button id="editar-'+data.usuario+'" class="btnEditar btn btn-primary glyphicon glyphicon-pencil"></button></div>';
                }
            }
        ],
